    ...
    return _regenerator().w(function (_context28) {
      while (1) switch (_context28.p = _context28.n) {
        ...
        case 1:
          ...
          _context28.p = 2;
          _t28 = operation;
          _context28.n = _t28 === 'find' ? 3 : _t28 === 'insertOne' ? 5 : _t28 === 'updateOne' ? 7 : _t28 === 'deleteOne' ? 9 : _t28 === 'aggregate' ? 11 : 13;
          break;
        case 3:
          _context28.n = 4;
        ...
        case 15:
          _context28.p = 15;
          _t29 = _context28.v;
          console.error("Error in ".concat(operation, " on ").concat(collectionName, ": "), _t29);
          throw _t29;
        case 16:
...
var storage = multer.diskStorage({
  destination: function destination(req, file, cb) {
    if (file.fieldname === 'profileImg') cb(null, 'uploads/profiles');else cb(null, 'uploads/projects');
  },
...
app.post('/api/users/register', upload.single('profileImg'), /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req, res) {
    var _req$body, username, email, password, name, surname, workplace, birthday, isAdmin, existingUser, profileImg, userDoc, result, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _req$body = req.body, username = _req$body.username, email = _req$body.email, password = _req$body.password, name = _req$body.name, surname = _req$body.surname, workplace = _req$body.workplace, birthday = _req$body.birthday, isAdmin = _req$body.isAdmin;
...
app.post('/api/users/login', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(req, res) {
    var _req$body2, username, password, user, _t2;
...
app.post('/api/project/', /*#__PURE__*/function () {
  var _ref0 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0(req, res) {
    var _req$body3, name, description, owner, members, type, hashtags, userExists, projectDoc, result, _t0;
    return _regenerator().w(function (_context0) {
      while (1) switch (_context0.p = _context0.n) {
        case 0:
          _context0.p = 0;
          _req$body3 = req.body, name = _req$body3.name, description = _req$body3.description, owner = _req$body3.owner, members = _req$body3.members, type = _req$body3.type, hashtags = _req$body3.hashtags;
          if (!(!name || !owner)) {
            _context0.n = 1;
            break;
          }
...
app.patch('/api/project/:id/checkin', /*#__PURE__*/function () {
  var _ref13 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee13(req, res) {
    var id, _req$body4, username, message, project, newVersion, checkinDoc, _t13;
    return _regenerator().w(function (_context13) {
      while (1) switch (_context13.p = _context13.n) {
        case 0:
          _context13.p = 0;
          id = new ObjectId(req.params.id);
          _req$body4 = req.body, username = _req$body4.username, message = _req$body4.message;
          _context13.n = 1;
          return queryDB('projects', 'find', {
            query: {
              _id: id
...
app.post('/api/friends/request', /*#__PURE__*/function () {
  var _ref16 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee16(req, res) {
    var _req$body5, requester, receiver, users, existing, friendDoc, result, _t16;
    return _regenerator().w(function (_context16) {
      while (1) switch (_context16.p = _context16.n) {
        case 0:
          _context16.p = 0;
          _req$body5 = req.body, requester = _req$body5.requester, receiver = _req$body5.receiver;
...
app["delete"]('/api/friends/unfriend', /*#__PURE__*/function () {
  var _ref19 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee19(req, res) {
    var _req$body6, username1, username2, existing, result, _t19;
    return _regenerator().w(function (_context19) {
      while (1) switch (_context19.p = _context19.n) {
        case 0:
          _context19.p = 0;
          _req$body6 = req.body, username1 = _req$body6.username1, username2 = _req$body6.username2;
...
app.post('/api/checkins/', /*#__PURE__*/function () {
  var _ref25 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee25(req, res) {
    var _req$body7, projectId, username, message, version, checkinDoc, result, _t25;
    return _regenerator().w(function (_context25) {
      while (1) switch (_context25.p = _context25.n) {
        case 0:
          _context25.p = 0;
          _req$body7 = req.body, projectId = _req$body7.projectId, username = _req$body7.username, message = _req$body7.message, version = _req$body7.version;
