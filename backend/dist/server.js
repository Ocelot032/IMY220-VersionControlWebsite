  ...
  _queryDB = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee34(collectionName, operation) {
    ...
    return _regenerator().w(function (_context34) {
      while (1) switch (_context34.n) {
        case 0:
          data = _args34.length > 2 && _args34[2] !== undefined ? _args34[2] : {};
          _context34.n = 1;
          return connectDB();
        case 1:
          db = _context34.v;
          ...
          _t34 = operation;
          _context34.n = _t34 === "find" ? 2 : _t34 === "insertOne" ? 4 : _t34 === "updateOne" ? 6 : _t34 === "deleteOne" ? 8 : _t34 === "delete" ? 10 : _t34 === "aggregate" ? 12 : 14;
          break;
        case 2:
          _context34.n = 3;
  ...
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(req, res) {
    ...
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        ...
        case 1:
          _db2 = _context4.v;
          users = _db2.collection("users");
          _req$params = req.params, username = _req$params.username, projectId = _req$params.projectId;
          _context4.n = 2;
        ...
        case 6:
          _context4.p = 6;
          _t4 = _context4.v;
          console.error("Save/Unsave project error:", _t4);
          res.status(500).json({
            error: "Server error while saving project"
          });
        case 7:
  ...
  var _ref5 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5(req, res) {
    ...
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.p = _context5.n) {
        ...
        case 1:
          _db3 = _context5.v;
          users = _db3.collection("users");
          projects = _db3.collection("projects");
          _context5.n = 2;
          return users.findOne({
        ...
        case 6:
          _context5.p = 6;
          _t5 = _context5.v;
          console.error("Error fetching saved projects:", _t5);
          res.status(500).json({
            error: "Server error while fetching saved projects"
          });
        case 7:
...
app.get('/api/users/:username', /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6(req, res) {
    var _target$friends, targetUsername, viewerUsername, users, target, visibleProfile, visibility, _t6;
    return _regenerator().w(function (_context6) {
      while (1) switch (_context6.p = _context6.n) {
        ...
        case 3:
          _context6.p = 3;
          _t6 = _context6.v;
          console.error('Get user error:', _t6);
          res.status(500).json({
...
app.get("/api/users/search/:term", /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context9) {
      while (1) switch (_context9.p = _context9.n) {
        ...
        case 2:
          _context9.p = 2;
          _t9 = _context9.v;
          console.error("User search error:", _t9);
          res.status(500).json({
    ...
    return _regenerator().w(function (_context0) {
      while (1) switch (_context0.p = _context0.n) {
        ...
        case 3:
          _context0.p = 3;
          _t0 = _context0.v;
          console.error('Delete user error:', _t0);
          res.status(500).json({
...
app.post('/api/users/:username/upload', function (req, res, next) {
  ...
  upload(req, res, /*#__PURE__*/function () {
    var _ref1 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee1(err) {
      var username, fileName, _t1;
...
app.get("/api/project/", /*#__PURE__*/function () {
  var _ref10 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee10(req, res) {
    var projects, normalizedProjects, _t10;
    return _regenerator().w(function (_context10) {
      while (1) switch (_context10.p = _context10.n) {
        ...
        case 2:
          _context10.p = 2;
          _t10 = _context10.v;
          console.error("Fetch projects error:", _t10);
          res.status(500).json({
...
app.get("/api/project/:id", /*#__PURE__*/function () {
  var _ref11 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee11(req, res) {
    var id, result, p, normalizedProject, _t11;
    return _regenerator().w(function (_context11) {
      while (1) switch (_context11.p = _context11.n) {
        ...
        case 3:
          _context11.p = 3;
          _t11 = _context11.v;
          console.error("Fetch project error:", _t11);
          res.status(500).json({
    ...
    return _regenerator().w(function (_context12) {
      while (1) switch (_context12.p = _context12.n) {
        ...
        case 3:
          _context12.p = 3;
          _t12 = _context12.v;
          console.error("Error fetching user projects:", _t12);
          res.status(500).json({
            error: "Internal server error."
          });
        case 4:
...
app.post("/api/projects/save/:id", /*#__PURE__*/function () {
  var _ref13 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee13(req, res) {
    var _user$savedProjects2, _db4, userId, projectId, user, alreadySaved, update, updatedUser, _t13;
    return _regenerator().w(function (_context13) {
      while (1) switch (_context13.p = _context13.n) {
        case 0:
          ...
          return _context13.a(2, res.status(401).json({
            error: "Not logged in"
          }));
        case 1:
          _context13.n = 2;
        ...
        case 2:
          ...
          _context13.n = 3;
          return _db4.collection("users").findOne({
            _id: userId
          });
        case 3:
          user = _context13.v;
        ...
        case 4:
          alreadySaved = (_user$savedProjects2 = user.savedProjects) === null || _user$savedProjects2 === void 0 ? void 0 : _user$savedProjects2.some(function (p) {
        ...
        case 7:
          _context13.p = 7;
          _t13 = _context13.v;
          console.error("Error saving project:", _t13);
          res.status(500).json({
            error: "Server error"
          });
        case 8:
...
app.get("/api/project/local/:username", /*#__PURE__*/function () {
  var _ref14 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee14(req, res) {
    var username, userArr, user, friendUsernames, projects, _t14;
    return _regenerator().w(function (_context14) {
      while (1) switch (_context14.p = _context14.n) {
        ...
        case 4:
          _context14.p = 4;
          _t14 = _context14.v;
          console.error("Fetch local projects error:", _t14);
          res.status(500).json({
      ...
      while (1) switch (_context15.p = _context15.n) {
        ...
        case 3:
          projectDoc = {
            ...
            hashtags: hashtags,
            files: ((_req$files = req.files) === null || _req$files === void 0 ? void 0 : _req$files.filter(function (f) {
              return f.fieldname === "files";
            }).map(function (f) {
              return f.filename;
            })) || [],
            ...
            checkedOutBy: "",
            activity: [],
            imageUrl: ((_req$files2 = req.files) === null || _req$files2 === void 0 || (_req$files2 = _req$files2.find(function (f) {
              return f.fieldname === "image";
            })) === null || _req$files2 === void 0 ? void 0 : _req$files2.filename) || "",
            discussion: [],
            createdAt: new Date()
          };
          _context15.n = 4;
        ...
        case 5:
          _context15.p = 5;
          _t15 = _context15.v;
          console.error("Create project error:", _t15);
          res.status(500).json({
    ...
    return _regenerator().w(function (_context16) {
      while (1) switch (_context16.p = _context16.n) {
        ...
        case 4:
          _context16.p = 4;
          _t16 = _context16.v;
          console.error("Image upload error:", _t16);
          res.status(500).json({
    ...
    return _regenerator().w(function (_context17) {
      while (1) switch (_context17.p = _context17.n) {
        ...
        case 3:
          _context17.p = 3;
          _t17 = _context17.v;
          console.error("File upload error:", _t17);
          res.status(500).json({
    ...
    return _regenerator().w(function (_context18) {
      while (1) switch (_context18.p = _context18.n) {
        ...
        case 3:
          _context18.p = 3;
          _t18 = _context18.v;
          console.error("File deletion error:", _t18);
          res.status(500).json({
...
app.patch("/api/project/:id/checkout", /*#__PURE__*/function () {
  var _ref19 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee19(req, res) {
    var id, username, project, activityDoc, _t19;
    return _regenerator().w(function (_context19) {
      while (1) switch (_context19.p = _context19.n) {
        ...
        case 6:
          _context19.p = 6;
          _t19 = _context19.v;
          console.error("Checkout error:", _t19);
          res.status(500).json({
...
app.patch("/api/project/:id/checkin", /*#__PURE__*/function () {
  var _ref20 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee20(req, res) {
    var id, _req$body3, username, message, project, newVersion, activityDoc, _t20;
    return _regenerator().w(function (_context20) {
      while (1) switch (_context20.p = _context20.n) {
        ...
        case 6:
          _context20.p = 6;
          _t20 = _context20.v;
          console.error("Checkin error:", _t20);
          res.status(500).json({
    ...
    return _regenerator().w(function (_context21) {
      while (1) switch (_context21.p = _context21.n) {
        ...
        case 3:
          _context21.p = 3;
          _t21 = _context21.v;
          console.error("Update project error:", _t21);
          res.status(500).json({
    ...
    return _regenerator().w(function (_context22) {
      while (1) switch (_context22.p = _context22.n) {
        ...
        case 4:
          _context22.p = 4;
          _t22 = _context22.v;
          console.error("Delete project error:", _t22);
          res.status(500).json({
    ...
    return _regenerator().w(function (_context23) {
      while (1) switch (_context23.p = _context23.n) {
        ...
        case 8:
          _context23.p = 8;
          _t23 = _context23.v;
          console.error('Friend request error:', _t23);
          res.status(500).json({
    ...
    return _regenerator().w(function (_context24) {
      while (1) switch (_context24.p = _context24.n) {
        ...
        case 6:
          _context24.p = 6;
          _t24 = _context24.v;
          console.error('Accept friend error:', _t24);
          res.status(500).json({
    ...
    return _regenerator().w(function (_context25) {
      while (1) switch (_context25.p = _context25.n) {
        ...
        case 1:
          ...
          return _context25.a(2, res.status(404).json({
            error: 'Friend request not found.'
          }));
        case 2:
          res.json({
        ...
        case 3:
          _context25.p = 3;
          _t25 = _context25.v;
          console.error('Decline friend error:', _t25);
          res.status(500).json({
    ...
    return _regenerator().w(function (_context26) {
      while (1) switch (_context26.p = _context26.n) {
        ...
        case 7:
          _context26.p = 7;
          _t26 = _context26.v;
          console.error('Unfriend error:', _t26);
          res.status(500).json({
...
app.get('/api/friends/:username', /*#__PURE__*/function () {
  var _ref27 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee27(req, res) {
    var username, accepted, friendUsernames, _t27;
    return _regenerator().w(function (_context27) {
      while (1) switch (_context27.p = _context27.n) {
        ...
        case 2:
          _context27.p = 2;
          _t27 = _context27.v;
          console.error('Get friends error:', _t27);
          res.status(500).json({
    ...
    return _regenerator().w(function (_context28) {
      while (1) switch (_context28.p = _context28.n) {
        ...
        case 2:
          _context28.p = 2;
          _t28 = _context28.v;
          console.error('Get pending error:', _t28);
          res.status(500).json({
    ...
    return _regenerator().w(function (_context29) {
      while (1) switch (_context29.p = _context29.n) {
        ...
        case 2:
          _context29.p = 2;
          _t29 = _context29.v;
          console.error("Fetch activity error:", _t29);
          res.status(500).json({
    ...
    return _regenerator().w(function (_context30) {
      while (1) switch (_context30.p = _context30.n) {
        ...
        case 3:
          _context30.p = 3;
          _t30 = _context30.v;
          console.error("Fetch project activity error:", _t30);
          res.status(500).json({
    ...
    return _regenerator().w(function (_context31) {
      while (1) switch (_context31.p = _context31.n) {
        ...
        case 2:
          _context31.p = 2;
          _t31 = _context31.v;
          console.error("Fetch user activity error:", _t31);
          res.status(500).json({
    ...
    return _regenerator().w(function (_context32) {
      while (1) switch (_context32.p = _context32.n) {
        ...
        case 2:
          _context32.p = 2;
          _t32 = _context32.v;
          console.error("Delete activity error:", _t32);
          res.status(500).json({
