...
const Splash = () => {
    return (
        <div id = "body">
            ...
            <p id = "subtitle">SYNC. TRACK. GROW.</p>
            <p id = "description">Zynthex is a modern version control platform built for seamless collaboration, tracking, and code management.
